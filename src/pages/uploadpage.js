...
function UploadPage(props) {
  ...
  const handleGetJson = async (event) => {
    ...
    axios
      .get(`http://localhost:8000/file/status/${jsonResponse.file_id}`)
      .then((response) => {
  ...
  return (
    ...
    <div class="container mx-auto px-4">
      <div
        class="justify-center flex p-4 mb-4 text-sm text-blue-700 bg-blue-100 rounded-lg dark:bg-blue-200 dark:text-blue-800"
        role="alert"
      >
        <svg
          aria-hidden="true"
        ...
        <div>
          <span class="font-medium">Info alert!</span> Please Upload One or More
          990 Form Images by Clicking on the Section Below.
        </div>
      </div>
      ...
      <div class="mt-40">
        ...
        <div class="justify-center flex">
          <p class="px-4 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">
            You can Upload one or more JPEG iamge files of 990 form by clicking
            the Button Below. Why wait? Let's get this started!
          </p>
        </div>
      </div>
