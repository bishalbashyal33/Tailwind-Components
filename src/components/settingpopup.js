      ...
      <div class="relative w-full h-full max-w-2xl md:h-auto">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div class="p-6 flex justify-start">
            ...
            <span class=" font-normal text-gray-900 dark:text-white">Modal Path:</span>
            </div>
            <div class="ml-2 flex flex-1 justify-start">
                <UDButton label="Select Path" field1="Demo Path" field2="Demo Path" field3="Demo Path" field4="Demo Path"/>
          ...
          <div class="pl-6 flex justify-start">
            ...
            <div class="ml-2 flex flex-1 justify-start">
            <span class=" font-semibold text-gray-900 dark:text-white">Token Classification</span>
