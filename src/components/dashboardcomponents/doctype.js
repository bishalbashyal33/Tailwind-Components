...
function DocType(props) {
  return (
    <a
      href="#"
      class="block m-2 max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"
    >
      <div class="flex">
        ...
        <div class="flex flex-grow justify-end">
          <svg
            ...
            data-modal-target="settingModal" data-modal-toggle="settingModal"
            fill="transparent"
            stroke="White"
            viewBox="0 0 20 20"
            xmlns="http://www.w3.org/2000/svg"
